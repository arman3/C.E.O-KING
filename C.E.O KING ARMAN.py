...
def banner():
	clear()
	wel='# WELCOME TO C.E.O KING ARMAN CRACK TOOL'
	cik2=mark(wel ,style='cyan')
	sol().print(cik2)
	ban='''
•   AUTHOR  : AOREC-XD WHATSAPP : +88013188058**  •
...
def login_lagi334():
	try:
		banner()
		___kontol___ = input('[|] C.E.O Cookies : ')
...
def menu(my_name,my_id):
	...
	io = '''[bold cyan][01] FREE FIRE  I'D CLONE	     [06] CRACK FROM FILES
